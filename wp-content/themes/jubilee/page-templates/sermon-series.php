...
function jubilee_sermon_series_after_content() {
	...
	<div id="jubilee-sermon-series" class="jubilee-sermon-index">
								...
								<div class="jubilee-sermon-series-dates">
									...
									if ( $series_data->sermon_earliest_date != $series_data->sermon_latest_date ) :
										...
										printf(
											...
											_x( '%s &ndash; %s', 'series date range', 'jubilee' ),
								...
								<div class="jubilee-sermon-series-count">
									...
									if ( 1 === $series_data->count ) {
										...
										printf(
											...
											_x( '%1$s %2$s', 'sermon count single', 'jubilee' ),
											$series_data->count,
									...
									// Multiple sermons.
										...
										printf(
											...
											_x( '%1$s %2$s', 'sermon count multiple', 'jubilee' ),
											$series_data->count,
											$sermon_word_plural
										);
		...
		<?php else : ?>
			...
			<p id="jubilee-sermon-index-none">
				<?php _e( 'There are no series to show.', 'jubilee' ); ?>
			</p>
...
add_action( 'jubilee_after_content', 'jubilee_sermon_series_after_content' );
