...
$cat_args = apply_filters( 'jubilee_widget_categories_args', $cat_args );

// Show as dropdown
if ( ! empty( $instance['show_dropdown'] ) ) {

	// Add category arguments to base array
	$cat_args['show_option_none'] = _x( 'Select One', 'categories widget', 'jubilee' );
	$cat_args['id'] = 'jubilee-dropdown-taxonomy_id-' . rand( 10000, 99999 );
	$cat_args['name'] = $cat_args['id'];
	$cat_args['class'] = 'jubilee-dropdown-taxonomy-redirect';
