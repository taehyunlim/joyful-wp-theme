...
$buttons = array();
	...
	if ( $blog_url ) {
		$buttons[$blog_url] = _x( 'More Posts', 'homepage blog button', 'jubilee' );
	}
	...
	<div class="jubilee-image-section-content jubilee-centered-large">
		...
		<div class="jubilee-image-section-content-inner">
			...
			<?php if ( $posts ) : ?>
				...
				<div class="jubilee-loop-entries jubilee-loop-<?php echo esc_attr( $columns ); ?>-columns jubilee-clearfix">
			...
			<?php else : ?>
				...
				<p>
					<?php echo esc_html( _x( 'There are no posts to show.', 'posts widget', 'jubilee' ) ); ?>
				</p>
