...
if ( ctfw_is_posts_page() ) : ?>
	...
	<h1 id="jubilee-main-title"><?php jubilee_title_paged(); ?></h1>
		...
		<div class="jubilee-entry-content jubilee-centered-medium">
			...
			<?php if ( ! have_posts() ) : ?>
				...
				<p class="jubilee-no-posts-message">
					<?php printf( __( 'There are no %s to show.', 'jubilee' ), $taxonomy_label_lc ); ?>
				</p>
...
elseif ( is_author() ) : ?>
	...
	<h1 id="jubilee-main-title"><?php echo jubilee_title_paged(); ?></h1>
...
<?php elseif ( is_search() ) : ?>
	...
	<div class="jubilee-entry-content jubilee-centered-medium">
		...
		<p>
			...
			printf( _n( 'Your search returned %d match for %s.', 'Your search returned %d matches for %s.', $wp_query->found_posts, 'jubilee' ), $wp_query->found_posts, '<b>' . get_search_query() . '</b>' );
			?>
...
elseif ( is_404() ) : ?>
	...
	<h1 id="jubilee-main-title"><?php jubilee_title_paged(); // outputs Not Found ?></h1>

	<div class="jubilee-entry-content jubilee-centered-medium">
		<?php _e( 'Sorry, the page or file you tried to access was not found.', 'jubilee' ); ?>
	</div>
