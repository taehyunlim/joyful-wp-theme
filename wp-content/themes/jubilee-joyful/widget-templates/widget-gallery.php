...
?>
	...
	?>
		<div class="jubilee-gallery-widget-link">
			<a href="<?php echo esc_url( get_permalink( $instance['post_id'] ) ); ?>" title="<?php echo esc_attr( get_the_title( $instance['post_id'] ) ); ?>" class="jubilee-button">
				<?php _ex( 'View Gallery', 'gallery widget', 'jubilee' ); ?>
			</a>
		</div>
	<?php endif; ?>
