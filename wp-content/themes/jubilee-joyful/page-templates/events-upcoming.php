 ...
 * partials/content-event-short.php outputs content for each post in the loop.
 */
...
function jubilee_events_upcoming_loop_after_content() {
...
add_filter( 'jubilee_loop_after_content_query', 'jubilee_events_upcoming_loop_after_content' );
